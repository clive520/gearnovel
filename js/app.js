      ...
      <div class="rounded-3xl border border-cyan-500/30 bg-gradient-to-br from-cyan-600/15 via-sky-500/10 to-slate-900/10 dark:to-slate-950/40 p-5 sm:p-7 flex flex-col justify-between shadow-xl transition-all hover:shadow-2xl hover:border-cyan-500/50 h-full relative group">
        ...
        <div>
          ...
          <div class="space-y-2 mb-5">
            ...
            <!-- 卷三 -->
            <a href="#/read/book-29/16" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-cyan-500/30 flex items-center justify-between hover:border-cyan-500 hover:bg-cyan-500/5 transition-all group/vol shadow-sm ring-1 ring-cyan-500/20">
              <div class="flex items-center gap-3 min-w-0">
                <span class="w-8 h-8 rounded-xl bg-cyan-500/15 text-cyan-600 font-black text-xs flex items-center justify-center flex-shrink-0">卷三</span>
                <div class="min-w-0">
                  <div class="text-sm font-bold text-slate-900 dark:text-white group-hover/vol:text-cyan-600 transition-colors flex items-center gap-1.5 truncate">
                    <span class="truncate">《挑戰者海淵的破曉信標》</span>
                    <span class="text-[10px] px-1.5 py-0.5 rounded-full bg-cyan-500 text-white font-bold flex-shrink-0 animate-pulse">連載中 · 第 16 章最新</span>
                  </div>
                  <div class="text-[11px] text-slate-500 truncate">第 13~16 章已上線 · 2.4 萬字 · 格里菲斯斷裂準則 × 因瓦錸銷釘 × 主動順應阻抗控制</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
        ...
        <div class="pt-4 border-t border-cyan-500/20 flex flex-col sm:flex-row items-center gap-2.5">
          <a href="#/read/book-29/16" class="w-full sm:w-auto flex-1 px-4 py-2.5 rounded-xl bg-cyan-600 hover:bg-cyan-700 text-white font-bold text-xs shadow-md shadow-cyan-600/20 flex items-center justify-center gap-1.5 transition-all hover:scale-[1.02] active:scale-95 text-center">
            <span>⚡ 立即閱讀第 16 章（最新上線）</span>
          </a>
