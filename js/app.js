...
(function () {
  ...
  const PROPER_NAMES_ZH = [
    ...
    { name: '漪姉', role: '女主角 · 天樞科學院天才少女' },
    { name: '罧貁銁', role: '男主角 · 雲海引航少年' },
    { name: '貁銁', role: '男主角 · 雲海引航少年' },
    { name: '露露', role: '折耳機械萌狐' },
    ...
    // === 系列 3, 4, 6：六年一班三部曲（我的老師不是人 / 來自未來的轉學生 / 全班作弊中） ===
    { name: '高峙舷', role: '六年一班班導 · 全能教育仿生人' },
    { name: '高老師', role: '六年一班班導 · 全能教育仿生人' },
    { name: '高導', role: '六年一班班導 · 高峙舷' },
    { name: '轆慄釁', role: '六年一班調皮點子王 · 掩護作戰總指揮' },
    { name: '阿釁', role: '六年一班調皮點子王 · 轆慄釁' },
    { name: '綝耘晴', role: '六年一班班長 · 理工天才地下機械師' },
    { name: '晴晴', role: '六年一班班長 · 綝耘晴 / 周予晴' },
    { name: '巫茞輆', role: '六年一班體育股長 · 肉包守護者' },
    { name: '老巫', role: '六年一班體育股長 · 巫茞輆' },
    { name: '老巫爸爸', role: '老巫的父親 · 雞腿賭注家長' },
    { name: '老巫媽媽', role: '老巫的母親' },
    { name: '柯媽媽', role: '家長會副會長 · 嚴格要求成績' },
    { name: '溜溜', role: '班級 AI 智慧小寵物 · 情報通報員' },
    { name: '周嚴', role: '鹿陽國小學務主任 · 黑面判官' },
    { name: '周主任', role: '鹿陽國小學務主任 · 周嚴' },
    { name: '黑面判官', role: '鹿陽國小學務主任 · 周嚴' },
    { name: '李博士', role: '先端科技研發主管 · 假修繕工' },
    { name: '邱守仁', role: '鹿陽國小校長 · 和藹茶道長者' },
    { name: '邱校長', role: '鹿陽國小現任校長 · 邱守仁' },
    { name: '尪伝恺', role: '六年一班學生 · 面部神經控制大師' },
    { name: '伝恺', role: '六年一班學生 · 尪伝恺' },
    { name: '林芸芸', role: '六年一班學生 · 鋼鐵意志勇氣少女' },
    { name: '芸芸', role: '六年一班學生 · 林芸芸' },
    { name: '陳阿達', role: '六年二班體育生 · 籃球健將' },
    { name: '林未晞', role: '來自約四十年後的時空旅人 · 六年一班轉學生' },
    { name: '未晞', role: '來自未來的時空旅人 · 林未晞' },
    { name: '小未晞', role: '未晞的童年模樣' },
    ...
    { name: '奷纭', role: '女主角 · 柳奷纭' },
    { name: '夏知星', role: '女配角 · 奷纭摯友 · 星夜下的和解者' },
    { name: '知星', role: '女配角 · 夏知星' },
    { name: '柳阿嬤', role: '長輩 · 奷纭的阿嬤' },
    { name: '阿嬤', role: '長輩 · 奷纭的阿嬤 · 跨越時空的守護' },
    { name: '畫中的自己', role: '心靈投射 · 奷纭內心深處的自癒化身' },

    // === 系列 7：不可思議事件簿 ===
    { name: '陸言', role: '男主角 · 齒輪名偵探' },
    { name: '言哥', role: '男主角 · 陸言' },
    { name: '沈星葵', role: '女主角 · 記憶共振探測者' },
    { name: '星葵', role: '女主角 · 沈星葵' },
    { name: '小葵', role: '女主角 · 沈星葵' },
    { name: '方小克', role: '核心主角 · 發明改裝狂人' },
    { name: '小克', role: '核心主角 · 方小克' },
    { name: '皮球', role: '事務所特工 · 探測刺蝟' },
    { name: '李奧', role: '霧角城私家偵探' },
    { name: '艾瑪小姐', role: '霧角城助手 · 艾瑪' },
    { name: '艾瑪', role: '霧角城助手' },
    { name: '托比', role: '機械工匠學徒' },
    { name: '發條魔術師', role: '傳奇神秘怪盜宿敵' },
    { name: '貝克先生', role: '校長貝克先生' },

    // === 系列 8：班上鳥事 ===
    { name: '陸書晴', role: '女主角 · 班長兼地下首席鳥語翻譯官' },
    { name: '書晴', role: '女主角 · 陸書晴' },
    { name: '晴子', role: '女主角 · 陸書晴的綽號' },
    { name: '林敬棠', role: '男主角 · 班級魔王兼撿鳥男孩' },
    { name: '敬棠', role: '男主角 · 林敬棠' },
    { name: '阿棠', role: '男主角 · 林敬棠的綽號' },
    { name: '棠哥', role: '男主角 · 林敬棠的尊稱' },
    { name: '林小麻', role: '靈魂鳥主角 · 雛麻雀小麻' },
    { name: '小麻', pattern: '小麻(?![雀])', role: '靈魂鳥主角 · 雛麻雀林小麻' },
    { name: '陳大山', role: '班級護衛 · 人體消音器兼門神' },
    { name: '許芳語', role: '班級特工 · 草本除臭陣地司令' },
    { name: '芳語', role: '班級特工 · 許芳語' },
    { name: '周自強', role: '後門哨兵 · 萬年睡神與早期預警機' },
    { name: '自強', role: '後門哨兵 · 周自強' },
    { name: '溫雅婷', role: '代課班導 · 菜鳥教育心理學碩士' },
    { name: '溫老師', role: '代課班導 · 溫雅婷' },

    // === 系列 9：平行時空的同班同學 ===
    { name: '林澈', role: '男主角 · 觀察派少年（A/B雙世界）' },
    { name: '周予晴', role: 'A 世界班長 · 理性規則維護者' },
    { name: '予晴', role: 'A 世界班長 · 周予晴' },
    { name: '趙小陽', role: 'B 世界班長 · 熱血人緣王' },
    { name: '小陽', role: 'B 世界班長 · 趙小陽' },
    { name: '吳達', role: '核心夥伴 · 班級智囊兼交換生' },
    { name: '阿達', role: '核心夥伴 · 吳達 / 陳阿達' },
    { name: '達哥', role: '核心夥伴 · 吳達在 B 世界的尊稱' },
    { name: '徐安安', role: '美術少女 · 心靈繪畫者' },
    { name: '安安', pattern: '(?<![平])安安(?![靜全])', role: '美術少女 · 徐安安' },
    { name: '郭小筠', role: '推理擔當 · 成績與邏輯天才' },
    { name: '小筠', role: '推理擔當 · 郭小筠' },
  ...
  const ZH_NAME_REGEX = new RegExp('(' + PROPER_NAMES_ZH.map(n => n.pattern || n.name.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&')).join('|') + ')', 'g');
  ...
  const PROPER_NAMES_EN = [
    ...
    { name: 'Elder Chronos', role: 'Clockwork Elder' },
    { name: 'Principal Qiu', role: 'Principal' },
    { name: 'Teacher Gao', role: 'Science Teacher' },
    { name: 'Jiang Jiang', role: 'Protagonist · Dynamic Engineer' },
    { name: 'Cheng Hao', role: 'Protagonist · Gear Inventor' },
    { name: 'Ye Yijie', role: 'Protagonist · Optics Prodigy' },
    { name: 'Chronos', role: 'Clockwork Realm Elder' },
    { name: 'Cecilia', role: 'Sky Navigator' },
    { name: 'Morris', role: 'Lighthouse Keeper' },
    { name: 'Yijie', role: 'Protagonist · Ye Yijie' },
    { name: 'Pico', role: 'Mechanical Dog' },
    ...
    // Series 5
    { name: 'Liu Qianyun', role: 'Protagonist · Crafting Girl' },
    ...
    // Series 7
    { name: 'Clockwork Magician', role: 'Legendary Phantom Thief' },
    { name: 'Shen Xingkui', role: 'Memory Resonance Detective' },
    { name: 'Fang Xiaoke', role: 'Invention Mechanic' },
    { name: 'Lu Yan', role: 'Gear Detective' },
    { name: 'Xingkui', role: 'Shen Xingkui' },
    { name: 'Xiaoke', role: 'Fang Xiaoke' },
    { name: 'Piqiu', role: 'Detective Hedgehog' },
    { name: 'Pique', role: 'Detective Hedgehog' },
    { name: 'Emma', role: 'Detective Assistant' },
    { name: 'Toby', role: 'Apprentice Mechanic' },
    { name: 'Leo', role: 'Private Detective' },

    // Series 8
    { name: 'Lin Ching-Tang', role: 'Protagonist · Troublemaker' },
    { name: 'Lin Jingtang', role: 'Protagonist · Troublemaker' },
    { name: 'Lu Shu-Ching', role: 'Class President · Bird Translator' },
    { name: 'Lu Shuqing', role: 'Class President · Bird Translator' },
    { name: 'Master Sparrow', role: 'Lin Hsiao-Ma' },
    { name: 'Chen Ta-Shan', role: 'Class Guard · Silencer' },
    { name: 'Chen Dashan', role: 'Class Guard · Silencer' },
    { name: 'Hsu Fang-Yu', role: 'Deodorizing Commander' },
    { name: 'Chou Tzu-Chiang', role: 'Rear Guard Sentry' },
    { name: 'Teacher Wen', role: 'Substitute Homeroom Teacher' },
    { name: 'Wen Ya-Ting', role: 'Substitute Teacher' },
    { name: 'Wen Yating', role: 'Substitute Teacher' },
    { name: 'Shuqing', role: 'Lu Shuqing' },
    { name: 'Jingtang', role: 'Lin Jingtang' },
    { name: 'Ah-Tang', role: 'Lin Jingtang' },
    { name: 'Hsiao-Ma', role: 'Sparrow Companion' },
    { name: 'Qingzi', role: 'Lu Shuqing' },

    // Series 9
    { name: 'Chou Yu-Ching', role: 'Class President (A World)' },
    { name: 'Chao Hsiao-Yang', role: 'Class President (B World)' },
    { name: 'Kuo Hsiao-Yun', role: 'Deduction Genius' },
    { name: 'Lai Ta-Hsiung', role: 'Cheerful Foodie' },
    { name: 'Teacher Liu', role: 'PE Teacher' },
    { name: 'Teacher Chen', role: 'Homeroom Teacher' },
    { name: 'Ching-Ching', role: 'Class President (Yu-Ching)' },
    { name: 'Xiao-Yang', role: 'Class President (Hsiao-Yang)' },
    { name: 'Hsiao-Yun', role: 'Kuo Hsiao-Yun' },
    { name: 'Lin Che', role: 'Protagonist · Observer Boy' },
    { name: 'An-An', role: 'Art Girl · Hsu An-An' },
  ...
  function handleRoute() {
    ...
    if (hash === '#/' || hash === '#/library') {
      ...
      const seriesId = hash.replace('#/', '');
      renderLibrary();
      setTimeout(() => {
        if (typeof window.openSeriesModal === 'function') {
          window.openSeriesModal(seriesId);
        }
      }, 50);
    ...
    return `
      <div class="rounded-3xl border border-amber-500/30 bg-gradient-to-br from-amber-500/10 via-amber-500/5 to-slate-900/10 dark:to-slate-950/40 p-5 sm:p-7 flex flex-col justify-between shadow-xl transition-all hover:shadow-2xl hover:border-amber-500/50 h-full">
        ...
        <div class="pt-4 border-t border-amber-500/20 flex items-center gap-3">
          <a href="#/read/book-1/1" class="flex-1 px-4 py-2.5 rounded-xl bg-amber-600 hover:bg-amber-700 text-white font-bold text-xs shadow-md shadow-amber-600/20 flex items-center justify-center gap-1.5 transition-all hover:scale-[1.02] active:scale-95 text-center">
            <span>📖 從頭開始閱讀</span>
          </a>
          <button onclick="window.openSeriesModal('series-1')" class="flex-1 px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 font-semibold text-xs transition-all text-center">
            📑 全 32 回目錄
          </button>
        </div>
      </div>
    ...
    return `
      <div class="rounded-3xl border border-rose-500/30 bg-gradient-to-br from-rose-500/10 via-purple-500/5 to-slate-900/10 dark:to-slate-950/40 p-5 sm:p-7 flex flex-col justify-between shadow-xl transition-all hover:shadow-2xl hover:border-rose-500/50 h-full">
        ...
        <div class="pt-4 border-t border-rose-500/20 flex items-center gap-3">
          <a href="#/read/book-4/1" class="flex-1 px-4 py-2.5 rounded-xl bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs shadow-md shadow-rose-600/20 flex items-center justify-center gap-1.5 transition-all hover:scale-[1.02] active:scale-95 text-center">
            <span>📖 從頭開始閱讀</span>
          </a>
          <button onclick="window.openSeriesModal('series-2')" class="flex-1 px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 font-semibold text-xs transition-all text-center">
            📑 全 30 回目錄
          </button>
        </div>
      </div>
  ...
  function getSeries3CardHtml() {
    return `
      <div class="rounded-3xl border border-sky-500/30 bg-gradient-to-br from-sky-500/10 via-cyan-500/5 to-slate-900/10 dark:to-slate-950/40 p-5 sm:p-7 flex flex-col justify-between shadow-xl transition-all hover:shadow-2xl hover:border-sky-500/50 h-full">
        ...
        <!-- 底部行動按鈕 -->
        <div class="pt-4 border-t border-sky-500/20 flex items-center gap-3">
          <a href="#/read/book-7/1" class="flex-1 px-4 py-2.5 rounded-xl bg-sky-600 hover:bg-sky-700 text-white font-bold text-xs shadow-md shadow-sky-600/20 flex items-center justify-center gap-1.5 transition-all hover:scale-[1.02] active:scale-95 text-center">
            <span>📖 從頭開始閱讀</span>
          </a>
          <button onclick="window.openSeriesModal('series-3')" class="flex-1 px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 font-semibold text-xs transition-all text-center">
            📑 全 24 回目錄
          </button>
        </div>
      </div>
      ...
      <div class="rounded-3xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 via-teal-500/5 to-slate-900/10 dark:to-slate-950/40 p-5 sm:p-7 flex flex-col justify-between shadow-xl transition-all hover:shadow-2xl hover:border-emerald-500/50 h-full">
        <div>
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 mb-3">
            ...
            <div class="flex items-center gap-2">
              <span class="text-xs font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 px-2.5 py-0.5 rounded-full border border-emerald-500/20 font-mono">
                👁️ ${window.StatsService ? window.StatsService.getSeriesReads('series-4') : '0'} 次閱讀
              </span>
          ...
          <p class="text-xs sm:text-sm font-bold text-emerald-600 dark:text-emerald-400 mb-3">
            當手腕上的倒數光環亮起，全班二十六人展開守護地球大作戰！
          </p>
          <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed mb-5">
            鹿陽國小六年一班迎來神秘轉學生林未晞，手腕戴著能投影破碎未來的時序手環。班長晴晴以科學調查揭開時空秘密，攜手點子王阿釁、吃貨老巫與AI萌寵溜溜發起『守護地球大作戰』！從垃圾分類、午餐零浪費到追查上游偷排管線，全班結成最強同盟，迎向笑中帶淚的奇蹟告別！
          </p>
          ...
          <div class="space-y-2 mb-5">
            <div class="text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center justify-between">
              <span>📚 收錄全三卷三部曲（全卷震撼完結）</span>
              <span class="text-emerald-600 font-mono font-bold">14.0 萬字</span>
            </div>

            <!-- 卷一 -->
            <a href="#/read/book-10/1" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-emerald-500/30 flex items-center justify-between hover:border-emerald-500 hover:bg-emerald-500/5 transition-all group shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                <span class="w-8 h-8 rounded-xl bg-emerald-500/15 text-emerald-600 font-black text-xs flex items-center justify-center flex-shrink-0">卷一</span>
                <div class="min-w-0">
                  <div class="text-sm font-bold text-slate-900 dark:text-white group-hover:text-emerald-600 transition-colors flex items-center gap-1.5 truncate">
              ...
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                <span class="text-[10px] text-slate-400 dark:text-slate-500 font-mono">👁️ ${window.StatsService ? window.StatsService.getBookReads('book-10') : ''}</span>
                <span class="text-xs text-emerald-600 font-bold group-hover:translate-x-1 transition-transform">閱讀 ➜</span>
              </div>
            </a>

            <!-- 卷二 -->
            <a href="#/read/book-11/1" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-teal-500/30 flex items-center justify-between hover:border-teal-500 hover:bg-teal-500/5 transition-all group shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                <span class="w-8 h-8 rounded-xl bg-teal-500/15 text-teal-600 font-black text-xs flex items-center justify-center flex-shrink-0">卷二</span>
                <div class="min-w-0">
                  <div class="text-sm font-bold text-slate-900 dark:text-white group-hover:text-teal-600 transition-colors flex items-center gap-1.5 truncate">
                    <span class="truncate">《守護地球大作戰》</span>
                    <span class="text-[10px] px-1.5 py-0.5 rounded-full bg-emerald-500 text-white font-bold flex-shrink-0">完結</span>
                  </div>
                  <div class="text-[11px] text-slate-500 truncate">第 9～16 章 · 5.1 萬字 · 淨灘行動 × 塑膠危機 × 綠色園遊會</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                <span class="text-[10px] text-slate-400 dark:text-slate-500 font-mono">👁️ ${window.StatsService ? window.StatsService.getBookReads('book-11') : ''}</span>
                <span class="text-xs text-teal-600 font-bold group-hover:translate-x-1 transition-transform">閱讀 ➜</span>
              </div>
            </a>

            <!-- 卷三 -->
            <a href="#/read/book-12/1" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-cyan-500/30 flex items-center justify-between hover:border-cyan-500 hover:bg-cyan-500/5 transition-all group shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                  <div class="text-sm font-bold text-slate-900 dark:text-white group-hover:text-cyan-600 transition-colors flex items-center gap-1.5 truncate">
                    <span class="truncate">《最後的守護》</span>
                    <span class="text-[10px] px-1.5 py-0.5 rounded-full bg-emerald-500 text-white font-bold flex-shrink-0">完結</span>
                  </div>
                  <div class="text-[11px] text-slate-500 truncate">第 17～24 章 · 5.1 萬字 · 追查偷排 × 空汙紅害 × 奇蹟告別</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                <span class="text-[10px] text-slate-400 dark:text-slate-500 font-mono">👁️ ${window.StatsService ? window.StatsService.getBookReads('book-12') : ''}</span>
                <span class="text-xs text-cyan-600 font-bold group-hover:translate-x-1 transition-transform">閱讀 ➜</span>
              </div>
            </a>
          </div>
        ...
        <div class="pt-4 border-t border-emerald-500/20 flex items-center gap-3">
          <a href="#/read/book-10/1" class="flex-1 px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs shadow-md shadow-emerald-600/20 flex items-center justify-center gap-1.5 transition-all hover:scale-[1.02] active:scale-95 text-center">
            <span>📖 從頭開始閱讀</span>
          </a>
          <button onclick="window.openSeriesModal('series-4')" class="flex-1 px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 font-semibold text-xs transition-all text-center">
            📑 全 24 回目錄
          </button>
        </div>
      </div>
  ...
  function getSeries12CardHtml() {
    return `
      <div class="rounded-3xl border border-slate-500/40 bg-gradient-to-br from-slate-800/25 via-cyan-950/20 to-slate-900/15 dark:to-slate-950/60 p-5 sm:p-7 flex flex-col justify-between shadow-xl transition-all hover:shadow-2xl hover:border-slate-400/60 h-full relative group">
        <div class="absolute -right-16 -top-16 w-56 h-56 bg-cyan-600/15 rounded-full blur-3xl pointer-events-none group-hover:bg-cyan-600/25 transition-all"></div>
        <div>
          <!-- 標籤與受眾 -->
          <div class="flex items-center justify-between flex-wrap gap-2 mb-3">
            <span class="px-3 py-1 rounded-full text-xs font-bold bg-slate-500/20 text-slate-700 dark:text-cyan-300 border border-slate-500/40 flex items-center gap-1.5 shadow-sm">
              <span class="w-2 h-2 rounded-full bg-cyan-400 animate-pulse"></span>
              <span>🔥 2026 全新法醫刑偵推理 · 全三卷 20 章大完結</span>
            </span>
            <div class="flex items-center gap-2">
              <span class="text-xs font-bold text-slate-700 dark:text-slate-300 bg-slate-500/15 px-2.5 py-0.5 rounded-full border border-slate-500/25 font-mono">
                👁️ ${window.StatsService ? window.StatsService.getSeriesReads('series-12') : '0'} 次閱讀
              </span>
              <span class="text-xs font-medium text-slate-500 dark:text-slate-400">青年～大眾適讀</span>
            </div>
          </div>

          <!-- 標題與引言 -->
          <h3 class="text-xl sm:text-2xl font-black text-slate-900 dark:text-white tracking-tight mb-1 leading-snug group-hover:text-cyan-400 transition-colors">
            《死者請保持安靜》
          </h3>
          <p class="text-xs sm:text-sm font-bold text-slate-600 dark:text-slate-400 mb-3">
            死者比活人更有禮貌，他們不會說謊，只是靜靜躺在解剖台前，等待一柄穿透迷霧的理性之刃！
          </p>
          <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed mb-5">
            濱江市深秋的江霧中，一枚卡在死者胃黏膜深處的黃銅鑰匙，撕開了一樁沉睡三十年的連環懸案。市局青年法醫病理學家裴以安、硬派刑偵副隊長周成林與實習法醫蘇棠，從胃內容物排空動力學、青銅雕像中的骨骼哈弗氏系統，到停屍房第十三具零下低溫冰櫃，以嚴謹的現代鑑識科學與微量物證重建，步步逼近跨越兩代人的罪惡核心！
          </p>

          <!-- 收錄全三卷列表 -->
          <div class="space-y-2 mb-5">
            <div class="text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center justify-between">
              <span>📚 全三卷長篇套書（全 20 章大完結）</span>
              <span class="text-cyan-500 font-mono font-bold">全 20 章完結 · 5.2 萬字</span>
            </div>

            <!-- 卷一 -->
            <a href="#/read/book-30/1" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-slate-500/30 flex items-center justify-between hover:border-slate-400 hover:bg-slate-500/5 transition-all group/vol shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                <span class="w-8 h-8 rounded-xl bg-slate-500/15 text-slate-600 dark:text-slate-300 font-black text-xs flex items-center justify-center flex-shrink-0">卷一</span>
                <div class="min-w-0">
                  <div class="text-sm font-bold text-slate-900 dark:text-white group-hover/vol:text-cyan-400 transition-colors flex items-center gap-1.5 truncate">
                    <span class="truncate">《胃袋裡的黃銅鑰匙》</span>
                    <span class="text-[10px] px-1.5 py-0.5 rounded-full bg-emerald-500 text-white font-bold flex-shrink-0">已完結</span>
                  </div>
                  <div class="text-[11px] text-slate-500 truncate">全 6 章已完結 · 1.5 萬字 · 胃排空動力學 × 羅卡定律 × 密室鎖死機關</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                <span class="text-[10px] text-slate-400 dark:text-slate-500 font-mono">👁️ ${window.StatsService ? window.StatsService.getBookReads('book-30') : ''}</span>
                <span class="text-xs text-slate-500 dark:text-slate-300 font-bold group-hover/vol:translate-x-1 transition-transform">閱讀 ➜</span>
              </div>
            </a>

            <!-- 卷二 -->
            <a href="#/read/book-31/7" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-indigo-500/30 flex items-center justify-between hover:border-indigo-400 hover:bg-indigo-500/5 transition-all group/vol shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                <span class="w-8 h-8 rounded-xl bg-indigo-500/15 text-indigo-500 font-black text-xs flex items-center justify-center flex-shrink-0">卷二</span>
                <div class="min-w-0">
                  <div class="text-sm font-bold text-slate-900 dark:text-white group-hover/vol:text-indigo-400 transition-colors flex items-center gap-1.5 truncate">
                    <span class="truncate">《雨夜骨骼交響曲》</span>
                    <span class="text-[10px] px-1.5 py-0.5 rounded-full bg-indigo-500 text-white font-bold flex-shrink-0">已完結</span>
                  </div>
                  <div class="text-[11px] text-slate-500 truncate">全 7 章已完結 · 1.8 萬字 · 骨質哈弗氏系統 × 矽藻檢驗 × 鐘樓齒輪與管風琴</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                <span class="text-[10px] text-slate-400 dark:text-slate-500 font-mono">👁️ ${window.StatsService ? window.StatsService.getBookReads('book-31') : ''}</span>
                <span class="text-xs text-indigo-500 font-bold group-hover/vol:translate-x-1 transition-transform">閱讀 ➜</span>
              </div>
            </a>

            <!-- 卷三 -->
            <a href="#/read/book-32/14" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-cyan-500/30 flex items-center justify-between hover:border-cyan-400 hover:bg-cyan-500/5 transition-all group/vol shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                <span class="w-8 h-8 rounded-xl bg-cyan-500/15 text-cyan-500 font-black text-xs flex items-center justify-center flex-shrink-0">卷三</span>
                <div class="min-w-0">
                  <div class="text-sm font-bold text-slate-900 dark:text-white group-hover/vol:text-cyan-400 transition-colors flex items-center gap-1.5 truncate">
                    <span class="truncate">《無聲的最後證詞》</span>
                    <span class="text-[10px] px-1.5 py-0.5 rounded-full bg-emerald-500 text-white font-bold flex-shrink-0">大完結</span>
                  </div>
                  <div class="text-[11px] text-slate-500 truncate">全 7 章完結 · 1.9 萬字 · 停屍房第13號冰櫃 × 零下20度密室 × 三十年終局</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                <span class="text-[10px] text-slate-400 dark:text-slate-500 font-mono">👁️ ${window.StatsService ? window.StatsService.getBookReads('book-32') : ''}</span>
                <span class="text-xs text-cyan-500 font-bold group-hover/vol:translate-x-1 transition-transform">閱讀 ➜</span>
              </div>
            </a>
          </div>
        </div>
        ...
        <!-- 底部行動按鈕 -->
        <div class="pt-4 border-t border-slate-500/20 flex flex-col sm:flex-row items-center gap-2.5">
          <a href="#/read/book-32/20" class="w-full sm:w-auto flex-1 px-4 py-2.5 rounded-xl bg-slate-700 hover:bg-slate-600 text-white font-bold text-xs shadow-md shadow-slate-700/20 flex items-center justify-center gap-1.5 transition-all hover:scale-[1.02] active:scale-95 text-center">
            <span>⚡ 閱讀大結局第 20 章（黎明時分，死者請安息）</span>
          </a>
          <a href="#/read/book-30/1" class="w-full sm:w-auto px-3.5 py-2.5 rounded-xl border border-slate-500/30 hover:bg-slate-500/10 text-slate-700 dark:text-slate-300 font-semibold text-xs transition-all text-center">
            📖 從第一卷開始
          </a>
          <button onclick="window.openSeriesModal('series-12')" class="w-full sm:w-auto px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 font-semibold text-xs transition-all text-center whitespace-nowrap">
            📑 全套目錄
          </button>
        </div>
      </div>
  ...
  // 卡片產生函數：第十一套《冒險齒輪：馬里亞納的深淵信標》
  function getSeries11CardHtml() {
    return `
      <div class="rounded-3xl border border-cyan-500/30 bg-gradient-to-br from-cyan-600/15 via-sky-500/10 to-slate-900/10 dark:to-slate-950/40 p-5 sm:p-7 flex flex-col justify-between shadow-xl transition-all hover:shadow-2xl hover:border-cyan-500/50 h-full relative group">
        <div class="absolute -right-16 -top-16 w-56 h-56 bg-cyan-500/15 rounded-full blur-3xl pointer-events-none group-hover:bg-cyan-500/25 transition-all"></div>
        <div>
          <!-- 標籤與受眾 -->
          <div class="flex items-center justify-between flex-wrap gap-2 mb-3">
            <span class="px-3 py-1 rounded-full text-xs font-bold bg-cyan-500/15 text-cyan-700 dark:text-cyan-300 border border-cyan-500/30 flex items-center gap-1.5 shadow-sm">
              ...
              <span>🔥 2026 全新重磅主線 · 第二卷連載中 · 第 7~9 章火熱上線</span>
            </span>
            <div class="flex items-center gap-2">
              <span class="text-xs font-bold text-cyan-600 dark:text-cyan-400 bg-cyan-500/10 px-2.5 py-0.5 rounded-full border border-cyan-500/20 font-mono">
                👁️ ${window.StatsService ? window.StatsService.getSeriesReads('series-11') : '0'} 次閱讀
              </span>
              <span class="text-xs font-medium text-slate-500 dark:text-slate-400">9～15 歲適讀</span>
            </div>
          </div>
          ...
          <!-- 標題與引言 -->
          <h3 class="text-xl sm:text-2xl font-black text-slate-900 dark:text-white tracking-tight mb-1 leading-snug group-hover:text-cyan-500 transition-colors">
            《冒險齒輪：馬里亞納的深淵信標》
          </h3>
          <p class="text-xs sm:text-sm font-bold text-cyan-600 dark:text-cyan-400 mb-3">
            向下下潛一萬一千公尺，每平方公分承受一噸海水的窒息深淵，唯有黃銅齒輪與彼此的心跳不會被壓碎！
          </p>
          <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed mb-5">
            誠浩在保養爺爺留下的古董天文座鐘底座時，意外觸發機關彈出一枚被超高壓海水侵蝕的特種鈦鋯合金信標卡盤，座標直指馬里亞納海溝最深處——挑戰者深淵！板塊隱沒帶深處的『深海零號鐘台』差速齒輪即將失控，72小時倒數計時啟動！誠浩、葉旖緁、將江、機械柴犬皮可攜手遠洋科考少女杜海嵐，搭乘『鸚鵡螺-IV 號』雙球殼黃銅抗壓深潛艇，向萬米深淵全速啟航！
          </p>
              ...
              <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                  <div class="text-sm font-bold text-slate-900 dark:text-white group-hover/vol:text-cyan-600 transition-colors flex items-center gap-1.5 truncate">
                    ...
                    <span class="text-[10px] px-1.5 py-0.5 rounded-full bg-cyan-500 text-white font-bold flex-shrink-0 animate-pulse">全 6 章已完結</span>
                  </div>
                  <div class="text-[11px] text-slate-500 truncate">全 6 章已完結 · 3.6 萬字 · 380°C 黑煙囪 × 水滴流體平衡擺 × 金屬玻璃鎖死</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
  ...
  // 卡片產生函數：第十套《冒險齒輪：齒輪星核的微縮旅人》
  function getSeries10CardHtml() {
    return `
      <div class="rounded-3xl border border-amber-500/30 bg-gradient-to-br from-amber-500/10 via-orange-500/5 to-slate-900/10 dark:to-slate-950/40 p-5 sm:p-7 flex flex-col justify-between shadow-xl transition-all hover:shadow-2xl hover:border-amber-500/50 h-full relative group">
        <div class="absolute -right-16 -top-16 w-56 h-56 bg-amber-500/10 rounded-full blur-3xl pointer-events-none group-hover:bg-amber-500/20 transition-all"></div>
        <div>
          <!-- 標籤與受眾 -->
          <div class="flex items-center justify-between flex-wrap gap-2 mb-3">
            ...
            <div class="flex items-center gap-2">
              <span class="text-xs font-bold text-amber-600 dark:text-amber-400 bg-amber-500/10 px-2.5 py-0.5 rounded-full border border-amber-500/20 font-mono">
                👁️ ${window.StatsService ? window.StatsService.getSeriesReads('series-10') : '0'} 次閱讀
              </span>
              <span class="text-xs font-medium text-slate-500 dark:text-slate-400">9～15 歲適讀</span>
            </div>
          </div>
          ...
          <p class="text-xs sm:text-sm font-bold text-amber-600 dark:text-amber-400 mb-3">
            當身高縮小成一毫米，整座古董天文鐘，就是無邊無際的黃銅宇宙！
          </p>
          <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed mb-5">
            鹿陽國小舊鐘樓閣樓，發明少年誠浩、學霸班長葉旖緁、死黨將江與機械柴犬皮可意外啟動了爺爺封存百年的『渾天星象天文座鐘』。微維度空間摺疊場瞬間將四人壓縮一千倍（身高僅 1.5 毫米），墜入龐大的齒輪底盤！主發條啟動 720 分鐘自毀倒數，微縮旅人們展開生死大突圍！
          </p>
          ...
          <div class="space-y-2 mb-5">
            ...
            <!-- 卷一 -->
            <a href="#/read/book-24/1" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-amber-500/30 flex items-center justify-between hover:border-amber-500 hover:bg-amber-500/5 transition-all group/vol shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                <span class="w-8 h-8 rounded-xl bg-amber-500/15 text-amber-600 font-black text-xs flex items-center justify-center flex-shrink-0">卷一</span>
                <div class="min-w-0">
                  ...
                  <div class="text-[11px] text-slate-500 truncate">全 6 章已完結 · 3.3 萬字 · 空間摺疊 × 游絲彈跳 × 主發條應力裂紋</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                <span class="text-[10px] text-slate-400 dark:text-slate-500 font-mono">👁️ ${window.StatsService ? window.StatsService.getBookReads('book-24') : ''}</span>
                <span class="text-xs text-amber-600 font-bold group-hover/vol:translate-x-1 transition-transform">閱讀 ➜</span>
              </div>
            </a>

            <!-- 卷二 -->
            <a href="#/read/book-25/7" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-amber-500/30 flex items-center justify-between hover:border-amber-500 hover:bg-amber-500/5 transition-all group/vol shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                  <div class="text-sm font-bold text-slate-900 dark:text-white group-hover/vol:text-amber-600 transition-colors flex items-center gap-1.5 truncate">
                    ...
                    <span class="text-[10px] px-1.5 py-0.5 rounded-full bg-emerald-500 text-white font-bold flex-shrink-0">第二卷完結</span>
                  </div>
                  <div class="text-[11px] text-slate-500 truncate">全 6 章已完結 · 3.6 萬字 · 錨式擒縱 × 行星差速輪 × 水銀陀螺</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                <span class="text-[10px] text-slate-400 dark:text-slate-500 font-mono">👁️ ${window.StatsService ? window.StatsService.getBookReads('book-25') : ''}</span>
                <span class="text-xs text-amber-600 font-bold group-hover/vol:translate-x-1 transition-transform">閱讀 ➜</span>
              </div>
            </a>
  ...
  function getSeries9CardHtml() {
    return `
      <div class="rounded-3xl border border-sky-500/30 bg-gradient-to-br from-sky-500/10 via-cyan-500/5 to-slate-900/10 dark:to-slate-950/40 p-5 sm:p-7 flex flex-col justify-between shadow-xl transition-all hover:shadow-2xl hover:border-sky-500/50 h-full relative group">
        ...
        <div>
          <!-- 標籤與受眾 -->
          <div class="flex items-center justify-between flex-wrap gap-2 mb-3">
            <span class="px-3 py-1 rounded-full text-xs font-bold bg-sky-500/15 text-sky-600 dark:text-sky-400 border border-sky-500/30 flex items-center gap-1.5 shadow-sm">
              <span class="w-2 h-2 rounded-full bg-sky-500 animate-pulse"></span>
              <span>🪞 2026 最新重磅完結 · 全三卷 24 章</span>
            </span>
            <div class="flex items-center gap-2">
              <span class="text-xs font-bold text-sky-600 dark:text-sky-400 bg-sky-500/10 px-2.5 py-0.5 rounded-full border border-sky-500/20 font-mono">
                👁️ ${window.StatsService ? window.StatsService.getSeriesReads('series-9') : '0'} 次閱讀
              </span>
              <span class="text-xs font-medium text-slate-500 dark:text-slate-400">9～15 歲適讀</span>
            </div>
          </div>
          ...
          <!-- 標題與引言 -->
          <h3 class="text-xl sm:text-2xl font-black text-slate-900 dark:text-white tracking-tight mb-1 leading-snug group-hover:text-sky-500 transition-colors">
            《平行時空的同班同學》
          </h3>
          <p class="text-xs sm:text-sm font-bold text-sky-600 dark:text-sky-400 mb-3">
            兩個世界只差一個小小的選擇，卻讓五十二個少年的人生截然不同。
          </p>
          <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed mb-5">
            離海堤兩條街的海聲國小，舊禮堂舞台後方蒙塵的老鏡在放學後泛起銀白漣漪。安靜退縮的林澈穿過時空裂縫，赫然遇見開朗自信的另一個自己！開學第三天體育課上的一句話讓同一個班級分道揚鑣；面對覆蓋危機與七天倒數，五十二位少年在理性與熱血中學會自我接納，迎來最動人的奇蹟！
          </p>

          <!-- 收錄全三卷列表 -->
          <div class="space-y-2 mb-5">
            <div class="text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center justify-between">
              <span>📚 全三卷三部曲（全卷震撼完結）</span>
              <span class="text-sky-600 font-mono font-bold">4.0 萬字</span>
            </div>

            <!-- 卷一 -->
            <a href="#/read/book-21/1" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-sky-500/30 flex items-center justify-between hover:border-sky-500 hover:bg-sky-500/5 transition-all group/vol shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                <span class="w-8 h-8 rounded-xl bg-sky-500/15 text-sky-600 font-black text-xs flex items-center justify-center flex-shrink-0">卷一</span>
                <div class="min-w-0">
                  <div class="text-sm font-bold text-slate-900 dark:text-white group-hover/vol:text-sky-600 transition-colors flex items-center gap-1.5 truncate">
                    <span class="truncate">《舊禮堂的鏡子》</span>
                    <span class="text-[10px] px-1.5 py-0.5 rounded-full bg-emerald-500 text-white font-bold flex-shrink-0">完結</span>
                  </div>
                  <div class="text-[11px] text-slate-500 truncate">第 1～8 章 · 1.5 萬字 · 銀白漣漪 × 鏡像相遇 × 輪流回家守則</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                <span class="text-[10px] text-slate-400 dark:text-slate-500 font-mono">👁️ ${window.StatsService ? window.StatsService.getBookReads('book-21') : ''}</span>
                <span class="text-xs text-sky-600 font-bold group-hover/vol:translate-x-1 transition-transform">閱讀 ➜</span>
              </div>
            </a>

            <!-- 卷二 -->
            <a href="#/read/book-22/1" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-cyan-500/30 flex items-center justify-between hover:border-cyan-500 hover:bg-cyan-500/5 transition-all group/vol shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                <span class="w-8 h-8 rounded-xl bg-cyan-500/15 text-cyan-600 font-black text-xs flex items-center justify-center flex-shrink-0">卷二</span>
                <div class="min-w-0">
                  <div class="text-sm font-bold text-slate-900 dark:text-white group-hover/vol:text-cyan-600 transition-colors flex items-center gap-1.5 truncate">
                    <span class="truncate">《被說出口的話》</span>
                    <span class="text-[10px] px-1.5 py-0.5 rounded-full bg-emerald-500 text-white font-bold flex-shrink-0">完結</span>
                  </div>
                  <div class="text-[11px] text-slate-500 truncate">第 9～16 章 · 1.3 萬字 · 覆蓋來襲 × 接力選拔重演 × 鏡裂危機</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                <span class="text-[10px] text-slate-400 dark:text-slate-500 font-mono">👁️ ${window.StatsService ? window.StatsService.getBookReads('book-22') : ''}</span>
                <span class="text-xs text-cyan-600 font-bold group-hover/vol:translate-x-1 transition-transform">閱讀 ➜</span>
              </div>
            </a>

            <!-- 卷三 -->
            <a href="#/read/book-23/1" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-indigo-500/30 flex items-center justify-between hover:border-indigo-500 hover:bg-indigo-500/5 transition-all group/vol shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                <span class="w-8 h-8 rounded-xl bg-indigo-500/15 text-indigo-600 font-black text-xs flex items-center justify-center flex-shrink-0">卷三</span>
                <div class="min-w-0">
                  <div class="text-sm font-bold text-slate-900 dark:text-white group-hover/vol:text-indigo-600 transition-colors flex items-center gap-1.5 truncate">
                    <span class="truncate">《留下來的人》</span>
                    <span class="text-[10px] px-1.5 py-0.5 rounded-full bg-emerald-500 text-white font-bold flex-shrink-0">大結局</span>
                  </div>
                  <div class="text-[11px] text-slate-500 truncate">第 17～24 章 · 1.2 萬字 · 時間投影 × 交換人生 × 奇蹟的早晨</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                <span class="text-[10px] text-slate-400 dark:text-slate-500 font-mono">👁️ ${window.StatsService ? window.StatsService.getBookReads('book-23') : ''}</span>
                <span class="text-xs text-indigo-600 font-bold group-hover/vol:translate-x-1 transition-transform">閱讀 ➜</span>
              </div>
            </a>
          </div>
        </div>
        ...
        <!-- 底部行動按鈕 -->
        <div class="pt-4 border-t border-sky-500/20 flex items-center gap-3">
          <a href="#/read/book-21/1" class="flex-1 px-4 py-2.5 rounded-xl bg-sky-600 hover:bg-sky-700 text-white font-bold text-xs shadow-md shadow-sky-600/20 flex items-center justify-center gap-1.5 transition-all hover:scale-[1.02] active:scale-95 text-center">
            <span>📖 開始閱讀第 1 卷</span>
          </a>
          <button onclick="window.openSeriesModal('series-9')" class="flex-1 px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 font-semibold text-xs transition-all text-center">
            📑 全 24 回大綱目錄
          </button>
        </div>
      </div>
    ...
    return `
      <div class="rounded-3xl border border-indigo-500/30 bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-slate-900/10 dark:to-slate-950/40 p-5 sm:p-7 flex flex-col justify-between shadow-xl transition-all hover:shadow-2xl hover:border-indigo-500/50 h-full">
        <div>
          ...
          <div class="space-y-2 mb-5">
            <div class="text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center justify-between">
              ...
              <span class="text-indigo-600 font-mono font-bold">10.3 萬字</span>
            </div>

            <!-- 卷一 -->
            <a href="#/read/book-17/6" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-indigo-500/30 flex items-center justify-between hover:border-indigo-500 hover:bg-indigo-500/5 transition-all group shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                  ...
                  <div class="text-[11px] text-slate-500 truncate">全 6 章大完結 · 3.7 萬字 · 幽靈鋼琴 × 消失第十三階 × 日晷 × 自轉銀齒輪</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
            ...
            <!-- 卷三 -->
            <a href="#/read/book-19/1" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-amber-500/30 flex items-center justify-between hover:border-amber-500 hover:bg-amber-500/5 transition-all group shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                <span class="w-8 h-8 rounded-xl bg-amber-500/15 text-amber-600 font-black text-xs flex items-center justify-center flex-shrink-0">卷三</span>
                <div class="min-w-0">
                  <div class="text-sm font-bold text-slate-900 dark:text-white group-hover:text-amber-600 transition-colors flex items-center gap-1.5 truncate">
                  ...
                  <div class="text-[11px] text-slate-500 truncate">全 6 章完結 · 3.2 萬字 · 龍蟾地動儀 × 萬向節死鎖 × 太極渾天儀世紀歸位</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                <span class="text-[10px] text-slate-400 dark:text-slate-500 font-mono">👁️ ${window.StatsService ? window.StatsService.getBookReads('book-19') : ''}</span>
                <span class="text-xs text-amber-600 font-bold group-hover:translate-x-1 transition-transform">閱讀 ➜</span>
              </div>
            </a>
          </div>
        ...
        <div class="pt-4 border-t border-indigo-500/20 flex items-center gap-3">
          <a href="#/read/book-19/6" class="flex-1 px-4 py-2.5 rounded-xl bg-amber-600 hover:bg-indigo-700 text-white font-bold text-xs shadow-md shadow-indigo-600/20 flex items-center justify-center gap-1.5 transition-all hover:scale-[1.02] active:scale-95 text-center">
            <span>🎉 閱讀大結局第 18 章（太極渾天儀世紀歸位）</span>
          </a>
  ...
  function renderLibrary() {
    ...
    const card10 = getSeries10CardHtml();
        ...
        <div class="relative mb-16">
          ...
          <div class="flex items-center justify-between flex-wrap gap-3 mb-6">
            ...
            <div class="flex items-center gap-2">
              ...
              <button onclick="window.nextHomeSlide()" class="p-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 hover:text-cyan-600 hover:border-cyan-500 shadow-sm transition-all active:scale-90" title="下一本">
  ...
  window.openSeriesModal = function(seriesId) {
    ...
    if (badgeEl) {
      const toneColor = series.themeTone === 'cyan' ? 'text-cyan-600' : (series.themeTone === 'rose' ? 'text-rose-600' : (series.themeTone === 'sky' ? 'text-sky-600' : (series.themeTone === 'emerald' ? 'text-emerald-600' : 'text-amber-600')));
      badgeEl.className = `text-xs font-bold ${toneColor} mb-0.5`;
      badgeEl.textContent = `${series.badge} · ${series.stats.statusText}`;
    }

    if (contentEl) {
      const volToneClass = series.themeTone === 'cyan' ? 'bg-cyan-500/15 text-cyan-600' : (series.themeTone === 'rose' ? 'bg-rose-500/15 text-rose-600' : (series.themeTone === 'sky' ? 'bg-sky-500/15 text-sky-600' : (series.themeTone === 'emerald' ? 'bg-emerald-500/15 text-emerald-600' : 'bg-amber-500/15 text-amber-600')));
      const hoverBorderClass = series.themeTone === 'cyan' ? 'hover:border-cyan-500/50 hover:bg-cyan-500/5 group-hover:text-cyan-600' : (series.themeTone === 'rose' ? 'hover:border-rose-500/50 hover:bg-rose-500/5 group-hover:text-rose-600' : (series.themeTone === 'sky' ? 'hover:border-sky-500/50 hover:bg-sky-500/5 group-hover:text-sky-600' : (series.themeTone === 'emerald' ? 'hover:border-emerald-500/50 hover:bg-emerald-500/5 group-hover:text-emerald-600' : 'hover:border-amber-500/50 hover:bg-amber-500/5 group-hover:text-amber-600')));
      const countColorClass = series.themeTone === 'cyan' ? 'text-cyan-600/90 dark:text-cyan-400' : (series.themeTone === 'rose' ? 'text-rose-600/90 dark:text-rose-400' : (series.themeTone === 'sky' ? 'text-sky-600/90 dark:text-sky-400' : (series.themeTone === 'emerald' ? 'text-emerald-600/90 dark:text-emerald-400' : 'text-amber-600/90 dark:text-amber-400')));
