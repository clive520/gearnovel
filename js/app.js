    ...
    return `
      <div class="rounded-3xl border border-indigo-500/30 bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-slate-900/10 dark:to-slate-950/40 p-5 sm:p-7 flex flex-col justify-between shadow-xl transition-all hover:shadow-2xl hover:border-indigo-500/50 h-full">
        <div>
          ...
          <div class="space-y-2 mb-5">
            <div class="text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center justify-between">
              ...
              <span class="text-indigo-600 font-mono font-bold">2.6 萬字</span>
            </div>

            <!-- 卷一 -->
            <a href="#/read/book-17/4" class="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-indigo-500/30 flex items-center justify-between hover:border-indigo-500 hover:bg-indigo-500/5 transition-all group shadow-sm">
              <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                  ...
                  <div class="text-[11px] text-slate-500 truncate">第 1～4 章已釋出 · 2.6 萬字 · 幽靈鋼琴 × 消失第十三階 × 雕像巡遊 × 被偷走影子的日晷</div>
                </div>
              </div>
              <div class="flex items-center gap-2 flex-shrink-0 ml-2">
        ...
        <div class="pt-4 border-t border-indigo-500/20 flex items-center gap-3">
          <a href="#/read/book-17/4" class="flex-1 px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs shadow-md shadow-indigo-600/20 flex items-center justify-center gap-1.5 transition-all hover:scale-[1.02] active:scale-95 text-center">
            <span>📖 續讀第 4 章</span>
          </a>
