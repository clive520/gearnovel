        ...
        <div>
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 mb-3">
            <span class="px-3 py-1 rounded-full text-xs font-bold bg-cyan-500/15 text-cyan-700 dark:text-cyan-300 border border-cyan-500/30 flex items-center gap-1.5 shadow-sm">
              ...
              <span>🌊 2026 全新重磅主線首發 · 第 1~5 章火熱上線</span>
            </span>
            <div class="flex items-center gap-2">
          ...
          <div class="space-y-2 mb-5">
            <div class="text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center justify-between">
              ...
              <span class="text-cyan-600 font-mono font-bold">第 1~5 章連載中</span>
            </div>
                ...
                <div class="flex items-center gap-3 min-w-0">
                  ...
                  <div class="min-w-0">
                    <div class="text-sm font-bold text-slate-900 dark:text-white flex items-center gap-1.5 truncate">
                      ...
                      <span class="text-[10px] px-1.5 py-0.5 rounded-full bg-cyan-500 text-white font-bold flex-shrink-0 animate-pulse">第 5 章最新上線</span>
                    </div>
                    <div class="text-[11px] text-slate-500 truncate">已上線 5 章 · 30,000 字 · 兩千米階梯 × 大王烏賊巨腕 × 抹香鯨捕食</div>
                  </div>
                </div>
                <div class="flex items-center gap-2 flex-shrink-0 ml-2">
                  <span class="text-[10px] text-slate-400 dark:text-slate-500 font-mono">👁️ ${window.StatsService ? window.StatsService.getBookReads('book-27') : ''}</span>
                            ...
                            <!-- 五章節直達按鈕 -->
              <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 mt-2 pt-2 border-t border-cyan-500/15">
                ...
                <a href="#/read/book-27/5" class="px-2 py-1.5 rounded-xl bg-cyan-500/15 hover:bg-cyan-500/25 border border-cyan-500/30 text-cyan-700 dark:text-cyan-300 text-xs font-bold flex items-center justify-between transition-all col-span-2 sm:col-span-1">
                  <span class="truncate">第 5 章 · 深淵巨腕</span>
