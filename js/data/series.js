...
window.GEAR_SERIES = [
  {
    ...
    subtitle: "少兒微觀硬核科幻 · 全三卷（第三卷連載中 · 第 13～15 章已上線）",
    badge: "🔥 第三卷全新連載 · 第 15 章已上線",
    badgeColor: "amber",
    ...
    stats: {
      ...
      totalWords: "8.7 萬字（第三卷連載中）",
      statusText: "第三卷連載中 · 第 13～15 章已上線"
    },
    volumes: [
      {
        bookId: "book-24",
      ...
      },
      {
        ...
        chaptersCount: 6,
        releasedChapters: 3,
        wordCount: "第 13～15 章已上線 · 1.8 萬字",
        status: "第三卷連載中（已釋出 3 章）",
        theme: "微重力漂浮 × 歐拉星軌 × 毛細之河 × 光壓共振腔",
        firstChapterId: 13
      }
    ],
    highlights: [
