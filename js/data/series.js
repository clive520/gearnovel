...
window.GEAR_SERIES = [
  {
    ...
    subtitle: "少兒微觀硬核科幻 · 全三卷連載中（第 1～3 章已上線）",
    badge: "🔥 2026 全新重磅連載 · 第 3 章已上線",
    badgeColor: "amber",
    ...
    stats: {
      ...
      totalChapters: 18,
      currentChaptersReleased: 3,
      totalWords: "1.6 萬字（連載中）",
      statusText: "第一卷連載中 · 第 1～3 章已上線"
    },
    volumes: [
      {
        bookId: "book-24",
        ...
        chaptersCount: 6,
        releasedChapters: 3,
        wordCount: "第 1～3 章已上線 · 1.6 萬字",
        status: "第一卷連載中（已釋出 3 章）",
